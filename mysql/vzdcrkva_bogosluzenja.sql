...
--
-- Table structure for table `bogosluzenja`
--

DROP TABLE IF EXISTS `bogosluzenja`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bogosluzenja` (
  `id` int NOT NULL AUTO_INCREMENT,
  `praznik` varchar(2000) DEFAULT NULL,
  `datum_bogosluzenja` varchar(255) DEFAULT NULL,
  `vreme_bogosluzenja` varchar(255) DEFAULT NULL,
  `datum_bdenija` varchar(255) DEFAULT NULL,
  `vreme_bdenija` varchar(255) DEFAULT NULL,
  `dodatne_informacije` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`id`)
