...
function positionEditorElement(editor: any, rect: { top: any; height: any; left: number; width: number; } | null) {
  if (rect === null) {
      ...
      {supportedBlockTypes.has(blockType) && (
        <>
          ...
          >
            ...
            <span className="text">{blockTypeToBlockName[blockType as BlockType]}</span>
