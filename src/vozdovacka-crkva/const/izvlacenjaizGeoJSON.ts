...
// let vitanovacka = JSON["features"].filter((d: any) => d["properties"] && (d["properties"]["building"] === "yes" || d["properties"]["building"] === "house" || d["properties"]["building"] === "apartments") && d["properties"]["addr:street"] && arrayOfNames.includes(d["properties"]["addr:street"]) && d["properties"]["addr:street"] !== "Војводе Степе" && d["properties"]["addr:street"] !== "Кумодрашка" && d["properties"]["addr:street"] !== "Витановачка");
//
...
// });
// izabraneParohije !== null && arrayOfNames.push(izabraneParohije[0].ime.cyr);
// let vitanovacka = JSON["features"].filter((d: any) => d["properties"] && (d["properties"]["building"] === "yes" || d["properties"]["building"] === "house" || d["properties"]["building"] === "apartments") && d["properties"]["addr:street"] && arrayOfNames.includes(d["properties"]["addr:street"]));
//
// console.log(vitanovacka);
// const a = vitanovacka.filter((d: any) => (
//     ( d["properties"]["addr:street"] === "Војводе Степе" &&
...
// });
// izabraneParohije !== null && arrayOfNames.push(izabraneParohije[0].ime.cyr);
// let vitanovacka = JSON["features"].filter((d: any) => d["properties"] && (d["properties"]["building"] === "yes" || d["properties"]["building"] === "house" || d["properties"]["building"] === "apartments") && d["properties"]["addr:street"] && ostaleParohije !== null && arrayOfNames.includes(d["properties"]["addr:street"]) && d["properties"]["addr:street"] !== "Булевар Ослобођења" && d["properties"]["addr:street"] !== "Војводе Степе");
// const a = vitanovacka.filter((d: any) => (
//     ( d["properties"]["addr:street"] === "Војводе Степе" &&
//         (
//             (
...
// });
// izabraneParohije !== null && arrayOfNames.push(izabraneParohije[0].ime.cyr);
// let vitanovacka = JSON["features"].filter((d: any) => d["properties"] && (d["properties"]["building"] === "yes" || d["properties"]["building"] === "house" || d["properties"]["building"] === "apartments") && d["properties"]["addr:street"] && ostaleParohije !== null && arrayOfNames.includes(d["properties"]["addr:street"]));
// const a = vitanovacka.filter((d: any) => (
//    ( d["properties"]["addr:street"] === "Кумодрашка" &&
//     (
//         (
